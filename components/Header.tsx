...
export function Header() {
  return (
    <header className="sticky top-0 z-40 border-b border-ink-100/60 bg-white/80 backdrop-blur">
      <nav
        aria-label="주요 메뉴"
      ...
      >
        ...
        <ul className="hidden items-center gap-7 text-sm font-medium text-ink-700 sm:flex">
          {navItems.map((item) => (
            <li key={item.href}>
