...
const features = [
  ...
  },
  {
    icon: Phone,
    title: '랜덤 통화',
    desc: '버튼 한 번으로 시작되는 1:1 음성 매칭. 글로는 표현 못 하는 분위기를 가볍게 목소리로 나눠보세요.',
  },
  {
    icon: Mic,
    title: '음성 메시지 채팅',
    desc: '텍스트만으로 부족할 때, 음성 메시지로 분위기까지 전해지는 익명채팅을 즐길 수 있어요.',
  },
  {
    icon: EyeOff,
    title: '1회 시크릿 사진 / 영상',
    desc: '딱 한 번만 열어볼 수 있는 시크릿 사진·영상. 캡처 알림과 자동 만료로 흘러갈 걱정 없이 가볍게 공유.',
  },
  {
    icon: Clock,
    title: '24시간 샷',
