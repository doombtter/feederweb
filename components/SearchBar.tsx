...
const docs: Doc[] = [
  {
    ...
    body: '피더 Feeder 100% 익명소셜 랜덤채팅 랜덤통화 새친구 음성 메시지 시크릿',
  },
  {
    id: 'feat-feed',
    section: '특징',
    sectionId: 'features',
    title: '익명 글 피드',
    body: '실명 없이 글 한 줄 익명소셜 댓글 100% 익명',
  },
  {
    id: 'feat-call',
    section: '특징',
    sectionId: 'features',
    title: '랜덤 통화',
    body: '1:1 음성 매칭 랜덤통화 하루 무료 횟수 모르는사람과 대화 목소리',
  },
  {
    id: 'feat-voice',
    section: '특징',
  ...
  },
  {
    ...
    sectionId: 'features',
    title: '1회 시크릿 사진 / 영상',
    body: '한 번만 열람 시크릿 사진 영상 캡처 알림 자동 만료 익명',
  },
  {
    id: 'feat-shot',
    section: '특징',
  ...
  },
  {
    ...
    sectionId: 'features',
    title: '안전한 대화 환경',
    body: '전화번호 인증 만 19세 이상 신고 차단 즉시 안전한 익명소셜',
  },
  {
    id: 'how',
    section: '시작 방법',
    sectionId: 'how',
    title: '3단계로 시작하는 익명채팅',
    body: '앱 다운로드 전화번호 인증 닉네임 글 피드 댓글 채팅 랜덤통화',
  },
  {
    id: 'download',
    section: '다운로드',
